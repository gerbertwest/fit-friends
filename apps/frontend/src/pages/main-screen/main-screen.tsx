            ...
            <ul className="special-for-you__list">
              <li className="special-for-you__item">
                <div className="thumbnail-preview">
                  <div className="thumbnail-preview__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/preview-03.webp, public/img/content/thumbnails/preview-03@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/preview-03.jpg" srcSet="public/img/content/thumbnails/preview-03@2x.jpg 2x" width="452" height="191" alt=""/>
                    </picture>
                  </div>
              ...
              <li className="special-for-you__item">
                <div className="thumbnail-preview">
                  <div className="thumbnail-preview__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/preview-02.webp, public/img/content/thumbnails/preview-02@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/preview-02.jpg" srcSet="public/img/content/thumbnails/preview-02@2x.jpg 2x" width="452" height="191" alt=""/>
                    </picture>
                  </div>
                  <div className="thumbnail-preview__inner">
              ...
              <li className="special-for-you__item">
                <div className="thumbnail-preview">
                  <div className="thumbnail-preview__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/preview-01.webp, public/img/content/thumbnails/preview-01@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/preview-01.jpg" srcSet="public/img/content/thumbnails/preview-01@2x.jpg 2x" width="452" height="191" alt=""/>
                    </picture>
                  </div>
                  <div className="thumbnail-preview__inner">
            ...
            <ul className="special-offers__list">
              <li className="special-offers__item is-active">
                <aside className="promo-slider">
                  ...
                  <div className="promo-slider__image">
                    <img src="public/img/content/promo-1.png" srcSet="public/img/content/promo-1@2x.png 2x" width="1040" height="469" alt="promo-photo"/>
                  </div>
              ...
              <li className="special-offers__item">
                <aside className="promo-slider">
                  <div className="promo-slider__overlay"></div>
                  <div className="promo-slider__image">
                    <img src="public/img/content/promo-2.png" srcSet="public/img/content/promo-2@2x.png 2x" width="1040" height="469" alt="promo-photo"/>
                  </div>
                  <div className="promo-slider__header">
              ...
              <li className="special-offers__item">
                <aside className="promo-slider">
                  <div className="promo-slider__overlay"></div>
                  <div className="promo-slider__image">
                    <img src="public/img/content/promo-3.png" srcSet="public/img/content/promo-3@2x.png 2x" width="1040" height="469" alt="promo-photo"/>
                  </div>
                  <div className="promo-slider__header">
                ...
                <div className="thumbnail-training">
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source type="image/webp" srcSet="public/img/content/thumbnails/training-06.webp, public/img/content/thumbnails/training-06@2x.webp 2x"/>
                          <img src="public/img/content/thumbnails/training-06.jpg" srcSet="public/img/content/thumbnails/training-06@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
              ...
              <li className="popular-trainings__item">
                <div className="thumbnail-training">
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source type="image/webp" srcSet="public/img/content/thumbnails/training-07.webp, public/img/content/thumbnails/training-07@2x.webp 2x"/>
                          <img src="public/img/content/thumbnails/training-07.jpg" srcSet="public/img/content/thumbnails/training-07@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
                    <p className="thumbnail-training__price"><span className="thumbnail-training__price-value">1600</span><span>₽</span>
                    </p>
              ...
              <li className="popular-trainings__item">
                <div className="thumbnail-training">
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source type="image/webp" srcSet="public/img/content/thumbnails/training-11.webp, public/img/content/thumbnails/training-11@2x.webp 2x"/>
                          <img src="public/img/content/thumbnails/training-11.jpg" srcSet="public/img/content/thumbnails/training-11@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
              ...
              <li className="popular-trainings__item">
                <div className="thumbnail-training">
                  <div className="thumbnail-training__inner">
                    <div className="thumbnail-training__image">
                      <picture>
                        <source type="image/webp" srcSet="public/img/content/thumbnails/training-09.webp, public/img/content/thumbnails/training-09@2x.webp 2x"/>
                          <img src="public/img/content/thumbnails/training-09.jpg" srcSet="public/img/content/thumbnails/training-09@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
            ...
            <ul className="look-for-company__list">
              <li className="look-for-company__item">
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/user-04.webp, public/img/content/thumbnails/user-04@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/user-04.jpg" srcSet="public/img/content/thumbnails/user-04@2x.jpg 2x" width="82" height="82" alt=""/>
                    </picture>
                  </div>
              ...
              <li className="look-for-company__item">
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/user-05.webp, public/img/content/thumbnails/user-05@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/user-05.jpg" srcSet="public/img/content/thumbnails/user-05@2x.jpg 2x" width="82" height="82" alt=""/>
                    </picture>
                  </div>
                  <div className="thumbnail-user__header">
              ...
              <li className="look-for-company__item">
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/user-06.webp, public/img/content/thumbnails/user-06@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/user-06.jpg" srcSet="public/img/content/thumbnails/user-06@2x.jpg 2x" width="82" height="82" alt=""/>
                    </picture>
                  </div>
                  <div className="thumbnail-user__header">
              ...
              <li className="look-for-company__item">
                <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
                  <div className="thumbnail-user__image">
                    <picture>
                      <source type="image/webp" srcSet="public/img/content/thumbnails/user-07.webp, public/img/content/thumbnails/user-07@2x.webp 2x"/>
                        <img src="public/img/content/thumbnails/user-07.jpg" srcSet="public/img/content/thumbnails/user-07@2x.jpg 2x" width="82" height="82" alt=""/>
                    </picture>
                  </div>
                  <div className="thumbnail-user__header">
