                  ...
                  <div className="thumbnail-training">
                    <div className="thumbnail-training__inner">
                      <div className="thumbnail-training__image">
                        <picture>
                          <source type="image/webp" srcSet="public/img/content/thumbnails/training-02.webp, public/img/content/thumbnails/training-02@2x.webp 2x"/>
                            <img src="public/img/content/thumbnails/training-02.jpg" srcSet="public/img/content/thumbnails/training-02@2x.jpg 2x" width="330" height="190" alt=""/>
                        </picture>
                      </div>
                ...
                <li className="my-trainings__item">
                  <div className="thumbnail-training">
                    <div className="thumbnail-training__inner">
                      <div className="thumbnail-training__image">
                        <picture>
                          <source type="image/webp" srcSet="public/img/content/thumbnails/training-08.webp, public/img/content/thumbnails/training-08@2x.webp 2x"/>
                            <img src="public/img/content/thumbnails/training-08.jpg" srcSet="public/img/content/thumbnails/training-08@2x.jpg 2x" width="330" height="190" alt=""/>
                        </picture>
                      </div>
                ...
                <li className="my-trainings__item">
                  <div className="thumbnail-training">
                    <div className="thumbnail-training__inner">
                      <div className="thumbnail-training__image">
                        <picture>
                          <source type="image/webp" srcSet="public/img/content/thumbnails/training-10.webp, public/img/content/thumbnails/training-10@2x.webp 2x"/>
                            <img src="public/img/content/thumbnails/training-10.jpg" srcSet="public/img/content/thumbnails/training-10@2x.jpg 2x" width="330" height="190" alt=""/>
                        </picture>
                      </div>
                ...
                <li className="my-trainings__item">
                  <div className="thumbnail-training">
                    <div className="thumbnail-training__inner">
                      <div className="thumbnail-training__image">
                        <picture>
                          <source type="image/webp" srcSet="public/img/content/thumbnails/training-12.webp, public/img/content/thumbnails/training-12@2x.webp 2x"/>
                            <img src="public/img/content/thumbnails/training-12.jpg" srcSet="public/img/content/thumbnails/training-12@2x.jpg 2x" width="330" height="190" alt=""/>
                        </picture>
                      </div>
